...
# Instead of replacing strings, let's parse and insert
svg_and_ball_html = """
      <!-- BALL TRAIL SVG -->
...
"""
svg_soup = BeautifulSoup(svg_and_ball_html, 'html.parser')

sticky = roster_section.find('div', class_='soorma-roster-sticky')
if sticky:
    sticky.insert(0, svg_soup)

# 3. Replace the script block inside the roster section
new_script = """
...
script_tag = roster_section.find('script')
if script_tag:
