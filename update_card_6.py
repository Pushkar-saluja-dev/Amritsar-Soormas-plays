...
url = 'https://cdn.prod.website-files.com/65dcd70b48edc3a7b446950e/69c25a35531c701dd0017c98_Group%201400005881.png'
...
if section:
    connector = section.find('div', id='search-connector-6')
    if connector:
